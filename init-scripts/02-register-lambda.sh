...
awslocal lambda create-function \
  ...
  --timeout 30 \
  --environment "Variables={APP_NAME=${APP_NAME},APP_VERSION=${APP_VERSION},S3_BUCKET=db-bucket,S3_PATH=classes,AWS_REGION=${AWS_REGION},AWS_ENDPOINT=localstack-lambda-class:4566,HOME=/tmp}"
